    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddFood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!foodName.equals("") && weight!=0){
                    JSONObject infosAll=APICommunication.getInfoFromFoodName(foodName,weight,"GR");
                    ...
                    float carboydrats=((Number)(((JSONObject)infosNutrient.get(0)).get("quantity"))).floatValue();
                    float proteins=((Number)(((JSONObject)infosNutrient.get(1)).get("quantity"))).floatValue();
                    float lipids=((Number)(((JSONObject)infosNutrient.get(2)).get("quantity"))).floatValue();
        ...
        editTextPortionWeight.setOnKeyListener(new View.OnKeyListener() {
            ...
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                buttonAddFood.setText("Add to your list");
                return false;
            }
        });
